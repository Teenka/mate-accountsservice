...
#define ICONDIR LOCALSTATEDIR "/lib/MateAccountsService/icons"
...
save_extra_data (User *user)
{
        ...
        if (error == NULL) {
                filename = g_build_filename ("/var/lib/MateAccountsService/users",
                                             user->user_name,
                                             NULL);
                 ...
                 const gchar *new_name)
{
        ...
        old_filename = g_build_filename ("/var/lib/MateAccountsService/users",
                                         old_name, NULL);
        new_filename = g_build_filename ("/var/lib/MateAccountsService/users",
                                         new_name, NULL);
                    ...
                    DBusGMethodInvocation *context)
{
        ...
        if (user->uid == uid)
                action_id = "org.freedesktop.mateaccounts.change-own-user-data";
        else
                action_id = "org.freedesktop.mateaccounts.user-administration";
